 ...
 *
 * @ORM\Table(name="colaboracion_artistica", indexes={@ORM\Index(name="fk_colaboracion_artistica_artista1_idx", columns={"artista_id"}), @ORM\Index(name="fk_colaboracion_artistica_cancion1_idx", columns={"cancion_id"}), @ORM\Index(name="fk_colaboracion_artistica_artista2_idx", columns={"artista_colaborador_id"})})
 * @ORM\Entity
 */
